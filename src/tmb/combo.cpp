...
static int leftPressed;
static int rightPressed;
static int trianglePressed;
static int circlePressed;
static int xPressed;
static int squarePressed;
static int L1Pressed;
static int L2Pressed;
static int R1Pressed;
static int R2Pressed;
...
// 99.55% matched; very minor delay slot swaps causing issues.
...
//     if (joyStick < -0x7E) {
//         this->leftPressedAnalog_buf[this->cur_frame] = 1;
//     } else if (joyStick >= 0x7F) {
//         this->rightPressedAnalog_buf[this->cur_frame] = 1;
//     } else {
//         int fr = this->cur_frame;
//         this->leftPressedAnalog_buf[fr] = 0;
//         this->rightPressedAnalog_buf[fr] = 0;
//     }

//     joyStick = inputFixAnalogValue(3, this->pad_index);
//     if (joyStick < -0x7E) {
//         this->upPressedAnalog_buf[this->cur_frame] = 1;
//     } else if (joyStick >= 0x7F) {
//         this->downPressedAnalog_buf[this->cur_frame] = 1;
//     } else {
//         int fr = this->cur_frame;
//         this->upPressedAnalog_buf[fr] = 0;
//         this->downPressedAnalog_buf[fr] = 0;
//     }
...
//                 case (type): this->state = (type); this->ClearSecretCode(); break
