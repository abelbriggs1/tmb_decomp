...
from .fix_gprel import fix_gprel
...
def generate(env: Environment, clean_first: bool = True):
    ...
    # Replace gprel relocations in `nonmatchings` ASM files so they can be compiled
    # in C/C++ TUs without errors on old GCC/GAS versions.
    fix_gprel(env)
